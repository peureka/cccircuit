...
function wrap(body, { unsubscribe = false } = {}) {
  const footer = unsubscribe
    ? `<p style="margin:0 0 8px;font-size:12px;color:#A0A0A0;">Powered by <a href="https://meetcircuit.com" style="color:#A0A0A0;text-decoration:underline;">Circuit</a></p>
<p style="margin:0;font-size:11px;"><a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#666;text-decoration:underline;">unsubscribe</a></p>`
    : `<p style="margin:0;font-size:12px;color:#A0A0A0;">Powered by <a href="https://meetcircuit.com" style="color:#A0A0A0;text-decoration:underline;">Circuit</a></p>`;
...
<p style="margin:0 0 40px;font-size:18px;font-weight:600;">Culture Club</p>
${body}
...
function renderConfirmation() {
  return wrap(`
<p style="margin:0 0 24px;font-size:16px;line-height:1.6;">welcome to the queue.</p>
<p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#A0A0A0;">we go to culture together. film screenings, comedy nights, supper clubs, gallery openings. a different format every week.</p>
<p style="margin:0;font-size:14px;line-height:1.6;color:#A0A0A0;">you'll hear from us when the next outing drops.</p>`);
}
...
module.exports = { renderConfirmation, renderShortlist, renderWildcard };
